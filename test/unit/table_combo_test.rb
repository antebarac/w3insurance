...
DELIMITER
  ...
  def test_table_combo
    ...
    t3 = t2 | t1
    assert_equal BigDecimal.new(0.0072, 4), t3.evaluate(:osigurana_svota => 180000)[:stopa]
    assert_equal BigDecimal.new(0.0084, 4), t3.evaluate(:osigurana_svota => 150000)[:stopa]
    t4 = t1 | t2
